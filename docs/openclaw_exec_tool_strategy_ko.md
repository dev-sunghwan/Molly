...
OpenClaw의 `exec` 사용 습관에 맞추기 위해 shell-friendly argv 스크립트를 추가했다. 현재 canonical entrypoint는 `scripts/molly_schedule_action.py`이고, 과거 create 전용 `scripts/molly_create_event.py`는 호환 wrapper로만 남긴다.
...
```bash
python3 /home/sunghwan/projects/Molly/scripts/molly_schedule_action.py create ...
```
...
```bash
/home/sunghwan/projects/Molly/.venv/bin/python /home/sunghwan/projects/Molly/scripts/molly_schedule_action.py create ...
```
